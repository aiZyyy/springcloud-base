...
@Configuration
@ConditionalOnProperty(value = "sixi-micro-service-common.web-mvc-configurer.enabled", havingValue = "true", matchIfMissing = true)
public class MvcConfigurer extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    @Value("${sixi-micro-service-common.session.create.policy:STATELESS}")
