...
import com.itzy.commonservice.interfaces.SixiMessageCallback;
import com.itzy.commonservice.interfaces.SixiMessageListener;
import lombok.Data;
...
public class RabbitMessageQueueConfigurer {
    ...
    @Bean
    @ConditionalOnBean(SixiMessageListener.class)
    @ConditionalOnMissingBean
    public SimpleMessageListenerContainer messageContainer(RabbitConfig rabbitConfig, SixiMessageListener sixiMessageListener) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public SixiMessageCallback sixiMessageCallback() {
        return new DefaultMessageCallback();
    }

    public static class DefaultMessageCallback implements SixiMessageCallback {
        @Override
